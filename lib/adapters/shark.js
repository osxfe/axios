...
var buildAbsoluteURL = require('./../helpers/buildAbsoluteURL');
...
module.exports = function sharkAdapter(config) {
  return new Promise(function dispatchSharkRequest(resolve, reject) {
    ...
    if (config.shark) {
      if (!isWKWebView) {
        ...
        if (isAndroid && method === 'POST' && requestData) {
          config.headers['X-TitansX-Body'] = requestData;
        }
